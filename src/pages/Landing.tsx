      ...
      <nav className="fixed top-0 z-50 w-full border-b border-white/5 bg-white/70 backdrop-blur-xl dark:bg-slate-950/70">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="hidden rounded-lg px-4 py-2 text-sm font-medium text-slate-600 transition hover:text-accent-500 dark:text-slate-300 sm:inline-flex"
            >
              Client Login
            </Link>
            <Link
