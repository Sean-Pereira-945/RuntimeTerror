...
**Status**: ⬜ Not Started
**Objective**: Implement asynchronous model updates from clients to the server, processing updates as they arrive instead of requiring synchronous rounds.

### Phase 3: Robust Aggregation
**Status**: ⬜ Not Started
**Objective**: Implement the robust aggregation algorithm (e.g., Trimmed Mean, Median) and the mitigation of malicious/noisy clients.
